...
Wails desktop app used to test the release workflow with Release Please.

## Development

```bash
cd apps/game-of-life
wails dev
```
...
Releases are automated using [Release Please](https://github.com/googleapis/release-please). It reads conventional commit messages to determine version bumps and generate changelogs.
